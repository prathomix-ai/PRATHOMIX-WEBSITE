...
const PLANS = [
  ...
  },
  {
    ...
    badge: 'Most Popular',
    features: [
      'Choice of 1 Ready-to-use AI Product',
  ...
  },
  {
    ...
    features: [
      ...
      'Scalable Cloud Architecture & Database',
      'Advanced API Integrations (Payments, Auth, etc.)',
      "White-label Solution (Client's Branding)",
      'High-Performance & Secure Infrastructure',
      'Priority Tech Support & Maintenance',
    ],
    cta: 'Contact Us',
    to: '/contact',
    highlight: false,
