...
const SERVICES = [
  {
    ...
    problem: "Customers have to wait hours for replies, and you miss out on potential sales when you're sleeping or busy.",
    solution: 'We build smart AI chatbots that instantly answer questions, book appointments, and capture leads 24/7.',
    tags: ['Groq','Hugging Face','LLaMA 3', 'Gemini Pro', 'NLP', 'FastAPI'],
    color: 'from-brand-400 to-teal-400',
  },
  {
    icon: Workflow,
    title: 'Process Automation & AI Workflows',
    problem: 'Your team wastes hours every week copy-pasting data, sending the same emails, and doing boring manual tasks.',
    solution: 'We connect your apps together so things happen automatically behind the scenes, saving you hours of manual work.',
  ...
  },
  {
    ...
    problem: "You have a great idea for an app or software, but don't know how to build it or make it look professional.",
    solution: "You bring the idea, we build the entire software from scratch. Fast, secure, and ready for your users.",
  ...
  },
  {
    ...
    problem: "You have lots of customer data and numbers, but it's scattered everywhere and doesn't make any sense.",
    solution: "We clean up your messy data and turn it into simple dashboards so you can see exactly how your business is doing.",
  ...
  },
  {
    ...
    problem: "You use 5 different tools (like CRM, billing, email), but none of them talk to each other, causing double-entry work.",
    solution: "We build custom bridges (APIs) so all your favorite software tools work together smoothly like one system.",
  ...
  },
  {
    ...
    problem: "You're worried that your website or customer data might get hacked because you haven't checked your security.",
    solution: "We deeply scan your software to find weak spots and lock them down, keeping your business safe from attacks.",
