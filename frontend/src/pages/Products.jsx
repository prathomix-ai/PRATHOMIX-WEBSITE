...
const PRODUCTS = [
  {
    ...
    link: '#',
    features: ['Voice Ordering', 'AI Fallback', 'QR Split-Bill', 'Hidden Admin'],
  },
  {
    icon: Navigation,
    name: 'Travojo',
  ...
  },
  {
    icon: ShoppingCart,
    name: 'Aura Thread',
    tagline: 'Smart E-Commerce Engine',
    description: 'A seamless online ordering system designed for clothing retail, featuring fast checkout and dynamic architecture.',
    status: 'Beta',
    badge: 'bg-orange-500/15 text-orange-400 border-orange-500/20',
    color: 'from-orange-400 to-amber-400',
    link: '#',
    features: ['Fast Checkout', 'Modern Web UI', 'Smooth Animations', 'Scalable Design'],
  },
  {
    icon: Stethoscope, 
